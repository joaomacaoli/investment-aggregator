...
class UserServiceTest {
  ...
  class createUser{
    ...
    @Test
    @DisplayName("Should throw exception whe error occurs")
  ...
  class getUserById {
    @Test
    @DisplayName("Should create a user with success when optional is present")
    void shouldCreateAUserWithSuccessWheOptionalIsPresent(){
    ...
    @Test
    @DisplayName("Should create a user with success when optional is empty")
    void shouldCreateAUserWithSuccessWheOptionalIsEmpty(){
  ...
  class deleteUserById {
    ...
    @Test
    @DisplayName("Should not delete user with when user NOT exists")
